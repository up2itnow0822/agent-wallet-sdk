...
## 1. ahmet/awesome-web3

**PR Title:** Add AgentWallet SDK — non-custodial wallet for AI agents
...
- **npm:** [agentwallet-sdk](https://www.npmjs.com/package/agentwallet-sdk) (v2.0.1)
- **Chain:** Base Mainnet (+ Ethereum, Arbitrum, Polygon)
- **License:** MIT
- **Key differentiator:** Non-custodial with on-chain spending caps — vs custodial (Coinbase CDP) or merchant-side (Stripe)

---

## 2. e2b-dev/awesome-ai-agents

**PR Title:** Add AgentWallet SDK — autonomous crypto spending for AI agents
...
- Budget forecasting, activity history, batch transfers
- Base Mainnet primary, multi-chain support
...
## 5. jim-schwoebel/awesome_ai_agents
...
- Update all GitHub URLs with the actual public repo URL before submitting
- Follow each repo's CONTRIBUTING.md for formatting rules
- Keep entries alphabetical within their section
- Most awesome lists require: active project, documentation, open source license
